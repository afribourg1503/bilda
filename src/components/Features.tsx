      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Track Progress, <br className="hidden sm:block" />Build Habits
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with social features to motivate, track, and celebrate your daily building progress.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Log your build sessions with manual timers or auto-log from GitHub. Track your daily progress and streaks."
            index={0}
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="m22 21-2-2"></path><path d="M16 16h6"></path></svg>}
            title="Social Feed"
            description="Share your progress and get kudos from fellow builders. Celebrate wins and stay motivated together."
            index={1}
          />
          <FeatureCard
            ...
            description="Visualize your building activity with GitHub-style heatmaps. See your streaks and progress over time."
            index={2}
          />
          <FeatureCard
            ...
            title="Challenges"
            description="Join weekly challenges and compete with other builders. Earn achievements and stay accountable."
            index={3}
          />
          <FeatureCard
            ...
            description="Organize your work with emoji and color-coded projects. Track progress across multiple projects."
            index={4}
          />
          <FeatureCard
            ...
            description="Auto-log your coding sessions from GitHub. Track commits, lines added, and files changed."
            index={5}
          />
        </div>
      </div>
